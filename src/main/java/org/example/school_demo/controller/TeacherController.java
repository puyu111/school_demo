...
import org.example.school_demo.dto.request.TeacherCreateReq;
...
public class TeacherController {
    ...
    public Result<PageResult<TeacherListResp>> getPageList(
        ...
        PageResult<TeacherListResp> result = teacherService.getPageList(pageReq, keyword, degree);
    ...
    public void downloadTemplate(HttpServletResponse response) throws IOException {
        ...
        List<TeacherDataDTO> demoList = Arrays.asList(
                ...
                buildDemo("", "王五", "男", "操作系统;计算机组成原理", "硕士研究生", "wangwu@university.edu.cn", "13712341234")
        );
